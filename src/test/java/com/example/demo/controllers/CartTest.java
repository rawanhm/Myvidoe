...
import static com.example.demo.controllers.OrderTest.createCart;
...
public class CartTest {
    ...
    public void setup() {
        ...
        when(userRepository.findByUsername("rawan")).thenReturn(createUser());
    ...
    public void addToCarttest() {
        ...
        assertEquals("rawan", actualCart.getUser().getUsername());
